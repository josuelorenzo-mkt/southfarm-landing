...
export class PublicationStore {
    ...
    finish(id, worker, target, now, actor = { type: 'worker', id: worker.id }) { return this.transaction(() => { let row = this.row(id); this.requireLiveWorkerLock(row, worker, now); if (row.final_action_at && !['completed', 'review_required'].includes(target))
