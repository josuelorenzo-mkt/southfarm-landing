...
def platform_dumps(platform):
    ...
    if platform == "instagram": return [
        [ui(text=account), ui(**{"content-desc": "Create New"}), ui(**{"content-desc": "old reel"})], [ui(**{"content-desc": "Create new reel"})], [ui(**{"content-desc": "Video thumbnail old 0:25"})], [ui(text=account)], [ui(text=account), ui(**{"content-desc": "Create New"}), ui(**{"content-desc": "old reel"})], [ui(**{"content-desc": "Create new reel"})], [ui(**{"content-desc": "Video thumbnail old 0:25"}), ui(**{"content-desc": "Video thumbnail new 0:25"})], [ui(**{"resource-id": "com.instagram.android:id/clips_right_action_button"})], [ui(text="Continue"), ui(text="Downloads privacy")], [ui(text="Write a caption and add hashtags...")], [ui(**{"class": "android.widget.EditText", "text": ""})], [ui(**{"class": "android.widget.EditText", "text": "safe"})], [ui(**{"class": "android.widget.EditText", "text": "safe test"})], [ui(text="Next")], [ui(text="About Reels"), ui(text="Share", **{"resource-id": "com.instagram.android:id/clips_nux_sheet_share_button", "bounds": "[600,1400][700,1500]"})], [ui(text="About Reels"), ui(text="Share", **{"resource-id": "com.instagram.android:id/clips_nux_sheet_share_button", "bounds": "[600,1400][700,1500]"})], [ui(text="Profile")], [ui(text="expected.account"), ui(**{"content-desc": "old reel"}), ui(**{"content-desc": "safe test reel"})]]
    if platform == "tiktok": return [
        [ui(text=account), ui(text="Create"), ui(**{"content-desc": "old-tile"})], [ui(text="Upload")], [ui(**{"resource-id": "com.zhiliaoapp.musically:id/ica", "content-desc": "old-tile"})], [ui(text=account)], [ui(text=account), ui(text="Create"), ui(**{"content-desc": "old-tile"})], [ui(text="Upload")], [ui(**{"resource-id": "com.zhiliaoapp.musically:id/ica", "content-desc": "old-tile"}), ui(**{"resource-id": "com.zhiliaoapp.musically:id/ica", "content-desc": remote})], [ui(text="Next (1)")], [ui(text="Next")], [ui(text="Add description...", **{"resource-id": "com.zhiliaoapp.musically:id/h00"})], [ui(**{"class": "android.widget.EditText", "text": ""})], [ui(**{"class": "android.widget.EditText", "text": "safe"})], [ui(**{"class": "android.widget.EditText", "text": "safe test"})], [ui(text="Add description..."), ui(text="Public"), ui(text="Post", **{"resource-id": "com.zhiliaoapp.musically:id/st6"})], [ui(text="Add description..."), ui(text="Public"), ui(text="Post", **{"resource-id": "com.zhiliaoapp.musically:id/st6"})], [ui(text="Profile")], [ui(text=account), ui(**{"content-desc": "old-tile"}), ui(**{"content-desc": "safe test 0"})]]
    return [
